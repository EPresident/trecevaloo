...
/**
 * This class manages the evaluation process using the right test collection and
 * runs to compute the metric set. It also provides the result visualization and
 * exportation methods.
 */
public class EvaluatorManager {
    ...
    public void evaluate() {
        ...
        int totalRunLines = computeAllRuns(); 
    ...
    private int computeAllRuns() {
        ...
        return totalRunLines;
    }

    /**
     * Set EvaluatorManager to calculate all values only over the judged
     * documents (either relevant or not relevant). All unjudged documents are
     * removed from the retrieved set before any calculation. Possibly leaving
     * an empty set, DO NOT USE, unless you really know what you're doing.
     */
    ...
    /**
     * Set the number of documents per topic to consider in the evaluation of
     * the run.
     *
    ...
    /**
     * Set EvaluatorManager to average over the complete set of topics in the
     * relevance judgements instead of the topics in the intersection of
     * relevance judgements (qrels) and the run. Missing topics will contribute
     * a value of 0 to all evaluation measures (which may or may not be
     * reasonable for a particular evaluation measure, but is reasonable for
     * standard TREC measures.) Default is off.
     */
    public void averageOverAllTopicsInCollection() {
        avgOverAllTopicsInCollection = true;
    }
     ...
     *
     * @param resultExporter instance of ResultExporter that define the type of
     * exportation.
     */
     ...
     *
     * @param resultViewer instance of ResultViewer that define the type of
     * visualization.
     */
